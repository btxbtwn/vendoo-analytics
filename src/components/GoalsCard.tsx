...
export default function GoalsCard({
  ...
  const [config, setConfig] = useState<GoalConfig>(() => getSavedGoals());
  ...
  return (
    <div className="surface-card glass-card rounded-2xl p-5">
      <div className="mb-5 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg border border-border bg-muted/20 px-3 py-1 text-[11px] font-medium text-secondary transition hover:border-border-hover hover:text-foreground"
        >
          {editing ? "Save" : "Edit"}
        </button>
      </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={field.key} className="space-y-1">
              ...
              <div className="flex items-center rounded-xl border border-border bg-muted/10 px-2 py-2">
