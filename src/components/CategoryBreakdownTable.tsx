...
export default function CategoryBreakdownTable({ data, compact = false }: CategoryBreakdownTableProps) {
  ...
  if (compact) {
    return (
      <div className="card w-full rounded-2xl border border-border bg-card p-4">
        <div className="mb-4">
          <h3 className="text-base font-semibold text-foreground">Category Breakdown</h3>
        ...
        <div className="space-y-3">
          {sorted.map((row) => (
            <div key={row.category} className="rounded-xl border border-border bg-muted/20 p-3">
  ...
  return (
    <div className="card w-full max-w-full overflow-hidden rounded-2xl border border-border bg-card p-4 md:p-6">
      <div className="mb-5">
        <h3 className="text-base font-semibold text-foreground">Category Breakdown</h3>
        <p className="mt-0.5 text-xs text-muted-foreground">COGS, ASP, and profit by category</p>
      </div>
