...
export default function Sidebar({
 ...
 >
 <div className="flex h-10 w-10 items-center justify-center bg-accent shadow-[0_0_32px_rgba(99,102,241,0.25)]">
 ...
 aria-expanded={!collapsed}
        className="rounded-none border border-border/70 bg-background/80 p-2 text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground"
 >
 ...
 className={`flex w-full items-center rounded-none py-3 text-sm font-medium transition-all duration-200 ${
 ...
 type="button"
 onClick={() => onTabChange(item.id)}
            className={`flex min-h-14 flex-col items-center justify-center gap-1 px-2 py-2 text-[11px] font-medium transition-colors rounded-none ${
              isActive
