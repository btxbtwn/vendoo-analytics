...
function YesterdayTodayCol({
 ...
 return (
    <div className="rounded-none border border-border/70 bg-background/50 px-3 py-3">
...
function QuickAction({
 ...
 href?: string;
  ...
  const className =
    "inline-flex items-center gap-1.5 rounded-none border border-border bg-background px-3 py-1.5 text-xs font-medium text-secondary transition-colors hover:border-border-hover hover:text-foreground";
