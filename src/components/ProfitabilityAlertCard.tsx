        ...
        <div className="mb-5">
          ...
          <div className="space-y-2">
            {lossLeaders.map((l) => (
              <div
                key={l.title}
                className="flex items-center justify-between rounded-xl border border-danger/20 bg-danger/5 px-3 py-2.5"
              >
        ...
        <div className="mb-5">
          ...
          <div className="space-y-2">
            {lowMarginCats.map((c) => (
              <div
                key={c.category}
                className="flex items-center justify-between rounded-xl border border-warning/20 bg-warning/5 px-3 py-2"
              >
                <div>
