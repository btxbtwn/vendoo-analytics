...
function ComparisonTooltip({
 ...
 return (
 <div className="min-w-[11rem] border border-border bg-card/95 px-4 py-3 shadow-2xl backdrop-blur-sm">
...
export default function LabelTagComparisonPanel({
 ...
 return (
 <div className="w-full max-w-full overflow-hidden border border-border bg-card p-4 md:p-6">
 <div className="mb-5">
